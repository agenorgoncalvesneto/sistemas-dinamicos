...
\end{enumerate}
%\textit{\#\#\# \\
%Aqui estão as duas coisas que eu não consegui demonstrar. Mostrar que $H$ é de classe $\CC^\infty$ e a igualdade $(IV)$. Não sei se é simples explicar como se faz através do email... Caso não seja possível, considerando que isso é uma questão de cálculo, acho que não tem muito problema seguir em frente e depois discutir com mais cuidado, em um momento oportuno.
%\\\#\#\#}
