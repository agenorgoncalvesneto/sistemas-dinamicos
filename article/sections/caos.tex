...
Iniciamos o estudo dos sistemas dinâmicos caóticos com a seguinte definição:
...
Intuitivamente, um sistema dinâmico é topologicamente transitivo quando é possível ir de uma vizinhança para qualquer outra através de iterações de $f$. A família quadrática exibe esse comportamento para $\mu > 2 + \sqrt{5}$.
...
Outra definição que precisamos para o estudo dos sistemas dinâmicos caóticos é a seguinte:
...
Novamente, a família quadrática exibe esse comportamento para $\mu > 2 + \sqrt{5}$.
...
Novamente, o Teorema \ref{teo 4-0} é válido para $4 < \mu \leq 2 + \sqrt{5}$, porém a demonstração é consideravelmente mais difícil.
