...
De acordo com a primeira parte, $\Lambda_1$ é a união de $2^1 = 2$ intervalos fechados disjuntos e $F$ restrita é cada um desses intervalos é uma bijeção com o intervalo $[0,1]$.
...
\item$F^{k-1}((\overline{x_1}, \overline{x_2})) = (x_1, x_2)$,
