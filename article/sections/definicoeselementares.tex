...
%Em particular, se $n=1$, dizemos que $p$ é um \textit{ponto fixo}.
%Denotamos o conjunto de todos os pontos periódicos de $f$ por $Per(f)$ e denotamos o conjunto de todos os pontos periódicos de $f$ com período $n$ por $Per_n(f)$. 
\end{definition}
